                   ...
                   {usuario === null ? 
                    <ul className="menuHeader">
                        <li className="containerLogo">
                            <img src="/arquivos/logo.jpg" alt="WINFAST"/>
                        </li>
                    </ul>
                   :
                        <ul className="menuHeader">
                            ...
                            <li className="headerContainerCoin"><span className="textPlainCoin">Coin:</span> <Coin number={usuario.monedas}/></li>
                            <li className="btnLogOut" onClick={() => cerrarSesion()}>
